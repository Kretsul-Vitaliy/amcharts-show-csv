am5.ready(function () {
  ...
  function loadData(ticker, series, granularity) {
    ...
    am5.net.load('./src/assets/csv/data_export.csv').then(function (result) {
      // Parse loaded data
  ...
  loadData('TSLA', [valueSeries, volumeSeries, sbSeries], currentGranularity);

  // Add comparing series
  addComparingSeries('ZL', 'ZL');
  addComparingSeries('MA', 'MA');
  ...
  function addComparingSeries(label, valueData) {
